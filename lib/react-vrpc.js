...
function createVrpcProvider() {
  ...
  var vrpc = new _vrpc.VrpcRemote({ topicPrefix: topicPrefix, brokerUrl: brokerUrl, username: username, password: password, token: token });
  ...
  (0, _createClass3.default)(VrpcInstanceMaker, [{
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var _props2, vrpc, instanceName;

        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _props2 = this.props, vrpc = _props2.vrpc, instanceName = _props2.instanceName;
    ...
    value: function render() {
      var _props3 = this.props,
          vrpc = _props3.vrpc,
          agentId = _props3.agentId,
          instanceName = _props3.instanceName,
          oldProps = _props3.oldProps,
          PassedComponent = _props3.PassedComponent;
          ...
          return _react2.default.createElement(
            ...
            function (vrpc) {
              return _react2.default.createElement(VrpcInstanceMaker, {
                ...
                className: className,
                args: args,
                instanceName: className && (0, _utils.lowerFirstChar)(className)
              });
            }
          );
        }
