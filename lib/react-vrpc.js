...
function withVrpc(PassedComponent, mapVrpcToProps) {
    ...
    (0, _createClass3.default)(ComponentWithVrpc, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (vrpcInfo) {
            var vrpcProps = mapVrpcToProps ? mapVrpcToProps(vrpcInfo, _this5.props) : vrpcInfo;
            return _react2.default.createElement(PassedComponent, (0, _extends6.default)({}, _this5.props, vrpcProps));
          }
        );
      }
    }]);
