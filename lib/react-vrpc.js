      ...
      Object.keys(backends).forEach(function (key) {
        if (!backends[key].instance && !backends[key].args) {
          ...
          var backend = {
            ...
            callAll: function () {
              var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(functionName) {
                for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key5 = 1; _key5 < _len; _key5++) {
...
function useClient(_ref18) {
  var onError = _ref18.onError;
