  ...
  (0, _createClass3.default)(VrpcBackendMaker, [{
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
        ...
        var _props, backends, broker, token, domain, username, password, client;
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 7:
                ...
                client.on('instanceNew', function () {
                  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(added, _ref6) {
                                ...
                                while (1) {
                                  switch (_context.prev = _context.next) {
                                    ...
                                    case 12:
                                      ...
                                      console.error('Could not attach to backend instance \'' + instance + '\', because: ' + _context.t0.message);
                ...
                client.on('instanceGone', function () {
                  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(gone, _ref9) {
                          ...
                          case 2:
                            ...
                            _loop2 = function _loop2() {
                              ...
                              gone.forEach(function (x) {
                                return dynamicBackends.delete(x);
                              });
                              _this2.setState(function (prevState) {
                ...
                client.on('agent', function () {
                  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(_ref12) {
                    var agent = _ref12.agent,
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 24:
                            ...
                            console.warn('Could not create instance \'' + (v.instance || '<anonymous>') + '\' for backend \'' + k + '\' because: ' + _context4.t0.message);
              ...
              case 14:
                ...
                console.error('VRPC client failed to connect because: ' + _context5.t0.message);
                ...
                return _regenerator2.default.wrap(function _callee6$(_context7) {
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        return _context7.abrupt('return', client.delete(id, { agent: _agent }));
      ...
      value: function renderConsumers(PassedComponent, backends, props) {
        ...
        if (index === -1) {
          return _react2.default.createElement(
            ...
            function (globalProps) {
              return _this6.renderConsumers(PassedComponent, backends, (0, _extends3.default)({}, props, globalProps), index + 1);
            }
          );
        }
        if (index < backends.length) {
          ...
          return _react2.default.createElement(
            ...
            null,
            function (vrpcProps) {
              return _this6.renderConsumers(PassedComponent, backends, (0, _extends3.default)({}, props, vrpcProps), index + 1);
            }
          );
        }
...
function useClient(_ref16) {
  var onError = _ref16.onError;
